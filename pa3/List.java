...
class List {
   private class Node{
      ...
      public boolean equals(Object other){
         ...
         if(other instanceof Node){
            that = (Node) other;
            equal = this.data.equals(that.data);
         }
         return equal;
      }
   }
   ...
   public boolean equals(Object other) {
      ...
      if(other instanceof List){
         that = (List) other;
         Node tracerA = front;
         Node tracerB = that.front;
         while (tracerA!=null) {
            if (tracerA.equals(tracerB)) {
   ...
   public String toString() {
      ...
      String temp = "";
      while(tracer!=null) {
         temp+=tracer.data.toString()+" ";
         tracer = tracer.next;
      }
      return temp;
   }

   // Returns a new List representing the same sequence as this
